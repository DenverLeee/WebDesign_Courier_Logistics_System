...
public class Util {
    ...
    public static String DBURL = "jdbc:mysql://localhost:3306/Final_Assignment?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&autoReconnect=true&failOverReadOnly=false&allowPublicKeyRetrieval=true";
    ...
    public static void main(String[] args) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Databse Fail！！！");
        }
    }
